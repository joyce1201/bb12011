...
app.layout = html.Div([
    ...
    style={'textAlign':'left','color':'#503D36','fort-size': 24},
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        R_chart4= dccGraph(figure=px.bar(x='['Automobile_Sales'].mean()', y= 'unemployment_rate',
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(x='Year', y='Automobile_Sales'))
...
#TASK 2.6: Returning the graphs for displaying Yearly data
        return [
                html.Div(className='chart-item', children=[html.Div(Y_chart1),html.Div(Y_chart2)],style={style={'display': 'flex'}),
                html.Div(className='chart-item', children=[html.Div(Y_chart3),html.Div(Y_chart4)],style={style={'display': 'flex'})
                ]
